    ...
    return (
        <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-indigo-500/30">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
                ...
                <h2 className="text-2xl font-bold text-slate-100 mb-2">Create your Organization Workspace</h2>
                <p className="text-sm text-slate-400">
                    Already have an account? <Link href="/auth/login" className="font-medium text-indigo-400 hover:text-indigo-300 transition-colors">Sign in</Link>
                </p>
            </div>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-slate-900/50 backdrop-blur-xl py-8 px-4 shadow-[0_0_50px_rgba(99,102,241,0.1)] border border-white/10 sm:rounded-2xl sm:px-10">
                    <form className="space-y-6" onSubmit={handleRegister}>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-1">Work Email address</label>
                            <input
                                type="email"
                                required
                                value={email}
